...
## Javascript Assignments  [![Build Status](https://travis-ci.com/waynet-inc/js-assignments.svg?branch=master)](https://travis-ci.com/waynet-inc/js-assignments-travis)
