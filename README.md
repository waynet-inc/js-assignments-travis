...
## Javascript Assignments  [![Build Status](https://travis-ci.org/waynet-inc/js-assignments-travis.svg?branch=master)](https://travis-ci.org/waynet-inc/js-assignments-travis)
