...
## Javascript Assignments  [![Build Status](https://travis-ci.org/waynet-inc/js-assignments.svg?branch=master)](https://travis-ci.org/waynet-inc/js-assignments-travis)
